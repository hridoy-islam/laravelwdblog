        ...
        <div class="row topmargin_30">
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/towing.png')}}" alt="" />
                        <h4 class="regular">
            ...
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/hail.png')}}" alt="" />
                        <h4 class="regular">
            ...
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/flood.png')}}" alt="" />
                        <h4 class="regular">
            ...
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/accident.png')}}" alt="" />
                        <h4 class="regular">
            ...
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/fire.png')}}" alt="" />
                        <h4 class="regular">
            ...
            <div class="col-md-4">
                <div class="with_padding">
                    <div class="teaser text-center">
                        <img src="{{asset('images/icons/motocycle.png')}}" alt="" />
                        <h4 class="regular">
...
<section id="quote" class="parallax get_quote section_padding_0 columns_margin_0">
    ...
    <img src="{{asset('images/hook.png')}}" alt="" class="top_image" data-animation="fadeInDown" />
</section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="owl-carousel" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-nav="true" data-margin="0">
                    <blockquote>
                        <img src="{{asset('images/faces/01.jpg')}}" alt="" /> Meatloaf laborum velit kielbasa. Drumstick sirloin lorem chicken swine biltong in short ribs duis bresaola. Veniam meatloaf cow incididunt in bacon kevin in pork belly ball tip duis ipsum. Ribeye et aliquip strip steak dolore in anim. Officia
                    ...
                    <blockquote>
                        <img src="{{asset('images/faces/02.jpg')}}" alt="" /> Meatloaf laborum velit kielbasa. Drumstick sirloin lorem chicken swine biltong in short ribs duis bresaola. Veniam meatloaf cow incididunt in bacon kevin in pork belly ball tip duis ipsum. Ribeye et aliquip strip steak dolore in anim. Officia
                        tongue bacon mollit esse. Ipsum deserunt salami jowl short ribs veniam.
                        <div class="item-meta lightfont">
                            <h5 class="highlight">Curtis Harrington</h5>
                            <p>Manager</p>
